import{u as s,j as n}from"./index-BTbyQpxy.js";import"./mermaid-z7jFjprN.js";const l={title:"🎬 Streaming Platform System Design Interview",date:"2025-06-07",tags:["System-Design","Streaming","Netflix"]};function i(r){const e={code:"code",h2:"h2",h3:"h3",hr:"hr",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...r.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.h2,{children:"Interview Question"}),`
...
`,n.jsx(e.pre,{children:n.jsx(e.code,{className:"language-mermaid",children:`flowchart TB\r
    subgraph Client["Client Layer"]\r
        A[Web App] \r
        B[Mobile App]\r
        C[Smart TV]\r
        D[Gaming Console]\r
    ...
    \r
    subgraph CDN["CDN Layer"]\r
        E[Global CDN]\r
        F[Edge Servers]\r
        G[Regional Cache]\r
    end\r
    \r
    subgraph Gateway["API Gateway"]\r
        H[Load Balancer]\r
        I[API Gateway]\r
        J[Rate Limiter]\r
    end\r
    \r
    subgraph Services["Microservices"]\r
        K[User Service]\r
        L[Content Service]\r
    ...
    \r
    subgraph Storage["Storage Layer"]\r
        W[Video Storage]\r
        X[Image Storage]\r
        Y[Backup Storage]\r
    end\r
    \r
    subgraph External["External Services"]\r
        Z[Payment Gateway]\r
        AA[Email Service]\r
...
`,n.jsx(e.pre,{children:n.jsx(e.code,{className:"language-mermaid",children:`flowchart LR\r
...
`]})]})}function c(r={}){const{wrapper:e}={...s(),...r.components};return e?n.jsx(e,{...r,children:n.jsx(i,{...r})}):i(r)}export{c as default,l as frontmatter};
