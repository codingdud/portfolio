import{j as e}from"./index-D75OJl6g.js";const o={title:"Android Optimization Techniques",date:"2025-01-15",tags:["android","performance"]};function r(i){const n={code:"code",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",ul:"ul",...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{children:"Android Optimization Techniques"}),`
...
`})})]})}function c(i={}){const{wrapper:n}=i.components||{};return n?e.jsx(n,{...i,children:e.jsx(r,{...i})}):r(i)}export{c as default,o as frontmatter};
