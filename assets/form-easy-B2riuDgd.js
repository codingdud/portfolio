import{u as i,j as n}from"./index-DchHdfwn.js";import"./mermaid-Dh5kuZkf.js";const a={title:"Building Easy Forms in React",date:"2025-02-01",tags:["react","forms"]};function t(r){const e={code:"code",h1:"h1",h2:"h2",p:"p",pre:"pre",...i(),...r.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.h1,{children:"Building Easy Forms in React"}),`
...
`})})]})}function m(r={}){const{wrapper:e}={...i(),...r.components};return e?n.jsx(e,{...r,children:n.jsx(t,{...r})}):t(r)}export{m as default,a as frontmatter};
